...
!-------------------------------------------------------
      ...
      rate(:,:,223) = 1.13e-13 * exp_fac(:,:)
      exp_fac(:,:) = exp( 360. * itemp(:,:) )
      rate(:,:,133) = 2.4e-12 * exp_fac(:,:)
      rate(:,:,199) = 9.9e-12 * exp_fac(:,:)
      ...
      rate(:,:,201) = 6.0e-11 * exp( 240. * itemp(:,:) )
      rate(:,:,202) = 1.15e-12 * exp( 430. * itemp(:,:) )
      rate(:,:,203) = 1.2e-16 * exp( 1580. * itemp(:,:) )
      rate(:,:,208) = 5.6e16 * exp( -10870. * itemp(:,:) )
      rate(:,:,209) = 3.5e10 * exp( -3560. * itemp(:,:) )
      rate(:,:,211) = 5e13 * exp( -9673. * itemp(:,:) )
      rate(:,:,213) = 5e13 * exp( -9946. * itemp(:,:) )
      rate(:,:,220) = 1.2e-11 * exp( -280. * itemp(:,:) )
      rate(:,:,222) = 1.90e-13 * exp( 520. * itemp(:,:) )
      exp_fac(:,:) = exp( 260. * itemp(:,:) )
      rate(:,:,224) = 4.9e-12 * exp_fac(:,:)
      rate(:,:,271) = 2.3e-12 * exp_fac(:,:)
      rate(:,:,273) = 8.8e-12 * exp_fac(:,:)
      rate(:,:,252) = 1.7e-12 * exp( -710. * itemp(:,:) )
      rate(:,:,253) = 1.4e-10 * exp( -470. * itemp(:,:) )
      rate(:,:,255) = 2.3e-11 * exp( -200. * itemp(:,:) )
      rate(:,:,256) = 2.8e-11 * exp( 85. * itemp(:,:) )
      exp_fac(:,:) = exp( 290. * itemp(:,:) )
      rate(:,:,257) = 6.4e-12 * exp_fac(:,:)
      rate(:,:,278) = 4.1e-13 * exp_fac(:,:)
      exp_fac(:,:) = exp( -800. * itemp(:,:) )
      rate(:,:,259) = 2.9e-12 * exp_fac(:,:)
      rate(:,:,269) = 1.7e-11 * exp_fac(:,:)
      rate(:,:,276) = 1.7e-11 * exp_fac(:,:)
      rate(:,:,260) = 7.3e-12 * exp( -1280. * itemp(:,:) )
      rate(:,:,261) = 2.6e-12 * exp( -350. * itemp(:,:) )
      exp_fac(:,:) = exp( 220. * itemp(:,:) )
      rate(:,:,263) = 2.7e-12 * exp_fac(:,:)
      rate(:,:,283) = 5.8e-12 * exp_fac(:,:)
      rate(:,:,265) = 8.1e-11 * exp( -30. * itemp(:,:) )
      rate(:,:,272) = 4.5e-12 * exp( 460. * itemp(:,:) )
      rate(:,:,274) = 1.2e-10 * exp( -430. * itemp(:,:) )
      rate(:,:,275) = 4.8e-12 * exp( -310. * itemp(:,:) )
      rate(:,:,279) = 6.0e-13 * exp( 230. * itemp(:,:) )
      rate(:,:,280) = 4.5e-14 * exp( -1260. * itemp(:,:) )
      itemp(:,:) = 300. * itemp(:,:)
      ...
      kinf(:,:) = 1.6e-12
      call jpl( rate(1,1,219), m, 0.6, ko, kinf, plnplv )
      ko(:,:) = 4.4e-32 * itemp(:,:)**1.3
      kinf(:,:) = 4.7e-11 * itemp(:,:)**0.2
      call jpl( rate(1,1,254), m, 0.6, ko, kinf, plnplv )
      ko(:,:) = 1.8e-31 * itemp(:,:)**3.4
      kinf(:,:) = 1.5e-11 * itemp(:,:)**1.9
      call jpl( rate(1,1,258), m, 0.6, ko, kinf, plnplv )
      ko(:,:) = 6.9e-31 * itemp(:,:)**1.0
      kinf(:,:) = 2.6e-11
      call jpl( rate(1,1,266), m, 0.6, ko, kinf, plnplv )
      ko(:,:) = 1.6e-32 * itemp(:,:)**4.5
      kinf(:,:) = 2.0e-12 * itemp(:,:)**2.4
      call jpl( rate(1,1,267), m, 0.6, ko, kinf, plnplv )
      ko(:,:) = 5.2e-31 * itemp(:,:)**3.2
      kinf(:,:) = 6.9e-12 * itemp(:,:)**2.9
      call jpl( rate(1,1,270), m, 0.6, ko, kinf, plnplv )
      ko(:,:) = 9.0e-32 * itemp(:,:)**1.5
      kinf(:,:) = 3.0e-11
      call jpl( rate(1,1,282), m, 0.6, ko, kinf, plnplv )

...
!---------------------------------------------------------------------
      ...
      save
      integer, parameter :: &
                pcnst = 119 +1, & ! number of advected constituents including cloud water
                pcnstm1 = 119, & ! number of advected constituents excluding cloud water
...
!--------------------------------------------------------------
      ...
      integer, parameter :: hetcnt = 0, & ! number of heterogeneous processes
                            ...
                            imp_nzcnt = 1274, & ! number of non-zero implicit matrix entries
                            ...
                            clscnt4 = 119, & ! number of species in implicit class
...
!--------------------------------------------------------------
  ...
  if( astat /= 0 ) then
     ...
     call endrun
      ...
      integer, parameter :: id_CH3SH = 111
      integer, parameter :: id_CH3S = 112
      integer, parameter :: id_CH3SO = 113
      integer, parameter :: id_CH3SOO = 114
      integer, parameter :: id_CH3SO2 = 115
      integer, parameter :: id_CH3SO3 = 116
      integer, parameter :: id_MSA = 117
      integer, parameter :: id_MTMP = 118
      integer, parameter :: id_HPMTF = 119
      ...
      integer, parameter :: rid_jclono2 = 38
      integer, parameter :: rid_jhocl = 39
      integer, parameter :: rid_jcl2o2 = 40
      integer, parameter :: rid_jbrono2 = 41
      integer, parameter :: rid_jhobr = 42
      integer, parameter :: rid_jbrcl = 43
      integer, parameter :: rid_jbro = 44
      integer, parameter :: rid_jcl2 = 45
      integer, parameter :: rid_uo_o2 = 46
      integer, parameter :: rid_uco_oha = 50
      integer, parameter :: rid_uco_ohb = 51
      integer, parameter :: rid_ol_oh = 55
      integer, parameter :: rid_ol_ho2 = 56
      integer, parameter :: rid_uho2_ho2 = 57
      integer, parameter :: rid_o1d_n2 = 62
      integer, parameter :: rid_o1d_o2 = 63
      integer, parameter :: rid_ol_o1d = 64
      integer, parameter :: rid_op_ho2 = 67
      integer, parameter :: rid_uno2_no3 = 72
      integer, parameter :: rid_un2o5 = 73
      integer, parameter :: rid_uoh_no2 = 75
      integer, parameter :: rid_uoh_hno3 = 76
      integer, parameter :: rid_uho2_no2 = 78
      integer, parameter :: rid_uhno4 = 80
      integer, parameter :: rid_op_mo2 = 83
      integer, parameter :: rid_uoh_c2h4 = 90
      integer, parameter :: rid_op_eo2 = 91
      integer, parameter :: rid_ol_c2h4 = 94
      integer, parameter :: rid_uoh_c3h6 = 95
      integer, parameter :: rid_ol_c3h6 = 96
      integer, parameter :: rid_op_po2 = 98
      integer, parameter :: rid_op_ch3co3 = 103
      integer, parameter :: rid_upan_f = 104
      integer, parameter :: rid_upan_b = 108
      integer, parameter :: rid_op_c2h5o2 = 111
      integer, parameter :: rid_op_c3h7o2 = 118
      integer, parameter :: rid_uoh_acet = 122
      integer, parameter :: rid_ol_isop = 127
      integer, parameter :: rid_op_isopo2 = 128
      integer, parameter :: rid_op_isopnbo2 = 133
      integer, parameter :: rid_ol_isopnb = 135
      integer, parameter :: rid_op_iepoxo2 = 140
      integer, parameter :: rid_ol_mvk = 142
      integer, parameter :: rid_op_mvko2 = 143
      integer, parameter :: rid_ol_macr = 150
      integer, parameter :: rid_op_macro2 = 152
      integer, parameter :: rid_op_macrno2 = 158
      integer, parameter :: rid_op_mao3 = 160
      integer, parameter :: rid_umpan_f = 164
      integer, parameter :: rid_umpan_b = 165
      integer, parameter :: rid_op_maopo2 = 170
      integer, parameter :: rid_op_ato2 = 172
      integer, parameter :: rid_op_ino2 = 184
      integer, parameter :: rid_ol_c10h16 = 197
      integer, parameter :: rid_n2o5h = 214
      integer, parameter :: rid_no3h = 215
      integer, parameter :: rid_ho2h = 216
      integer, parameter :: rid_no2h = 217
      integer, parameter :: rid_so2h = 218
      integer, parameter :: rid_uoh_dms = 221
      integer, parameter :: rid_mtmp_i = 228
      integer, parameter :: rid_hpmtf_a = 229
      integer, parameter :: rid_hno3_d1 = 231
      integer, parameter :: rid_hno3_d2 = 232
      integer, parameter :: rid_hno3_d3 = 233
      integer, parameter :: rid_hno3_d4 = 234
      integer, parameter :: rid_hno3_d5 = 235
      integer, parameter :: rid_no3_d1 = 236
      integer, parameter :: rid_no3_d2 = 237
      integer, parameter :: rid_no3_d3 = 238
      integer, parameter :: rid_no3_d4 = 239
      integer, parameter :: rid_no3_d5 = 240
      integer, parameter :: rid_n2o5_d1 = 241
      integer, parameter :: rid_n2o5_d2 = 242
      integer, parameter :: rid_n2o5_d3 = 243
      integer, parameter :: rid_n2o5_d4 = 244
      integer, parameter :: rid_n2o5_d5 = 245
      integer, parameter :: rid_so2_d1 = 246
      integer, parameter :: rid_so2_d2 = 247
      integer, parameter :: rid_so2_d3 = 248
      integer, parameter :: rid_so2_d4 = 249
      integer, parameter :: rid_so2_d5 = 250
      integer, parameter :: rid_nh3h = 251
      integer, parameter :: rid_strat13 = 253
      integer, parameter :: rid_strat14 = 254
      integer, parameter :: rid_strat20 = 255
      integer, parameter :: rid_strat21 = 256
      integer, parameter :: rid_strat22 = 257
      integer, parameter :: rid_strat23 = 258
      integer, parameter :: rid_strat24 = 259
      integer, parameter :: rid_strat25 = 260
      integer, parameter :: rid_strat26 = 261
      integer, parameter :: rid_strat27 = 262
      integer, parameter :: rid_strat28 = 263
      integer, parameter :: rid_strat29 = 264
      integer, parameter :: rid_strat33 = 265
      integer, parameter :: rid_strat35 = 266
      integer, parameter :: rid_strat37 = 267
      integer, parameter :: rid_strat38 = 268
      integer, parameter :: rid_strat39 = 269
      integer, parameter :: rid_strat40 = 270
      integer, parameter :: rid_strat41 = 271
      integer, parameter :: rid_strat42 = 272
      integer, parameter :: rid_strat43 = 273
      integer, parameter :: rid_strat44 = 274
      integer, parameter :: rid_strat45 = 275
      integer, parameter :: rid_strat46 = 276
      integer, parameter :: rid_strat47 = 277
      integer, parameter :: rid_strat48 = 278
      integer, parameter :: rid_strat69 = 279
      integer, parameter :: rid_strat58 = 280
      integer, parameter :: rid_strat59 = 281
      integer, parameter :: rid_strat64 = 282
      integer, parameter :: rid_strat71 = 283
      integer, parameter :: rid_strat72 = 284
      integer, parameter :: rid_strat73 = 285
      integer, parameter :: rid_strat74 = 286
      integer, parameter :: rid_strat75 = 287
      integer, parameter :: rid_strat76 = 288
      integer, parameter :: rid_strat77 = 289
      integer, parameter :: rid_strat78 = 290
      integer, parameter :: rid_strat79 = 291
      integer, parameter :: rid_strat80 = 292
